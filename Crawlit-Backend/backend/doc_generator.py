...
IGNORE_FILE_TYPES = {
    ...
    ".zip", ".tar", ".gz", ".rar", ".git",
    ".min.js", ".map", ".d.ts", ".lock", ".log", ".tmp", ".bak",
    ".claude", ".bin", ".exe", ".dll", ".so", ".o", ".obj",
    ".github", ".gitlab", ".vscode", ".idea", ".DS_Store",
}

SKIP_DIRS = {
    ".git", "node_modules", "dist", "build", "__pycache__",
    ".next", ".vscode", ".gitignore", "coverage", "out",
    "target", "venv", ".venv", "env", ".claude", ".ollama", ".idea", ".github", ".gitlab",
    "eslint", "prettier", "tests", "spec", "docs", "doc", "examples",
}

# Lockfiles, configs, and other autogenerated/boilerplate files that add
# noise to the docs without much value.
SKIP_FILES = {
    ...
    "jest.config.js", ".eslintrc", ".eslintrc.json", ".eslintrc.js",
